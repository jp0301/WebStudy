...
--○ 전체 데이터 조회 쿼리문 구성 (SID, NAME, TEL, KOR, ENG, MAT) → 기능 개선 → LEFT JOIN
...
--○ 생성한뷰(VIEW_MEMBERSCORE)를 활용한 상세 리스트 조회 쿼리문 구성
